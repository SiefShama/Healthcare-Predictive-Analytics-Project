...
def prediction_section():
    ...
    if model_type == "Classification":
        ...
        model_data = {
            ...
            "R² Score": [0.3398, -0.2955,  0.3928,  0.2679],
            "MAE": [0.3129, 0.3121,  0.2845,  0.2905],
            "RMSE": [0.3961, 0.5549,  0.3799,  0.4171],
            "Notes": [
                "Base regressor",
        ...
        st.markdown("""
        - **Best Models**: `xgbr_DD` outperforms others in R² and MAE, providing the most accurate regression predictions.
